...
<div class="edit-container">
    ...
    <form>
        ...
        <div class="btn-actions">
            ...
            <a href="/todos" class="btn btn-secondary" style="display: inline-block; padding: 10px 20px; color: #fff; background-color: #6c757d; text-decoration: none; border-radius: 5px; font-size: 16px; text-align: center; transition: background-color 0.3s ease;">Back to Todo list</a>
        </div>
    </form>
</div>
</body>
